...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{$app_url}application/storage/icon/fav.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{$app_url}application/storage/icon/fav.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{$app_url}application/storage/icon/fav.png">
    ...
    <link rel="shortcut icon" href="{$app_url}application/storage/icon/fav.png">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom">
                <nav class="navbar navbar-fixed-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <img class="logo" style="max-height: 40px; width: auto;" src="{$app_url}application/storage/system/logoo.png" alt="Logo">
